...
export const getCart = (id) => {
  return async (dispatch) => {
    await axios.get(`/shoppingCarts/detail/${id}`).then((response) => {
      console.log("response.data: ", response.data);
...
export const removeQuantity = (data) => {
  ...
  return async (dispatch) => {
    await axios
      .post("/shoppingCarts/deleteProductFromShoppingCart", data)
      .then((response) => {
        console.log(response.data);
...
export const getQuantity = (id) => {
  return async (dispatch) => {
    await axios.get(`/shoppingCarts/quantity/${id}`).then((response) => {
      dispatch({ type: "GET_QUANTITY", payload: response.data });
    });
  };
};
...
export const addFavorite = (data) => {
  return async (dispatch) => {
    await axios.post("/users/favorites", data).then((response) => {
